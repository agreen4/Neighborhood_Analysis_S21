...
blogdown::shortcode("figure", src = "/schedule/session/03-Starting_with_Data_files/1_LearningCurve.png", caption = "Learning Curves for Popular Data Analysis Tools", type="Markdown")
```
