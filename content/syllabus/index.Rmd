...
This course teaches techniques for analyzing the demographic, economic, physical, and social conditions that exist at the neighborhood and local government scale. While our focus will be on analyzing current conditions, we will also learn how to tell stories about neighborhood change, and will learn how to project and forecast future trends. We will learn how to describe community characteristics with small area census data, work with local administrative data, and will learn how to design primary data collection strategies to fill in gaps in knowledge gained through exploration and analysis.
...
2. Learn how to use [R](https://www.r-project.org), [RStudio](https://rstudio.com), and [Github](https://github.com) in service of creating reproducible analysis of
...
Our class will meet synchronously online twice per week. As the weather improves (and assuming public health concerns abate), some course sessions may include the option to meet in person following all University of Illinois classroom safety precautions). 
...
Given our focus on learning by doing, I am expecting a polished end product by the end of the semester. As you will note in the in the syllabus section on your [Grading Contract](#evaluation-and-grading-contract), we will use a contract-based evaluation system this semester. Regardless of the grade you contract for, I expect that your final work in this class will be of “A” quality, meaning that it is ready for dissemination.

## What to Expect from Me

- **Availability:** I am generally accessible 9am to 5pm Monday to Friday, however I have research and administrative commitments in addition to teaching and advising during the work week. I have generally reserved dedicated time on Tuesdays and Thursdays to focus on our class and student advising.
- **Communicating:** The easiest ways to communicate with me outside of class are via [email](mailto:agreen4@illinois.edu) or our course [Slack channel](https://neighborhooda-esb1724.slack.com). I try to respond to emails sent during the week within 24 hours. Emails sent over the weekend will receive a response within 48 hours. If you don't hear from me after that amount of time elapses, please feel welcome to nudge me to respond.
...
- **Troubleshooting:** You should feel welcome to use email, slack, and office hours to get help with troubleshooting problems as they arise in your work. The [Resources](/resource/#learning-r) page provides thoughts and resources for troubleshooting errors as they occur. I suggest using Slack as an initial means of soliciting collective support for problems you are having - it is highly likely that others in the class have encountered similar problems, and also allows us to create a collective repository of our problems and responses.

## What I Expect from You

- **Be Present:** I expect that you'll engage fully in our course sessions and in our class community.
- **Seek Balance:** I expect that you'll actively work to find balance between the many demands in your life. This means finding time for adequate rest and sleep, exercise, and other actions that support your mental and physical health.
- **Actively Support Each Other:** I expect that each of you will take on leadership roles within our class, that includes actively supporting our learning community over the course of the semester. While this expectation becomes harder to meet due to remote learning, those circumstances make it all the more important to actively support our learning community.
- **Read with Care:** This course is not particularly reading intensive since our focus is on learning by doing, however, there are important details contained within the documentation on our course website and within reading selections. Be intentional about reading carefully and completely important course documents (including this syllabus).
- **Act with Integrity:** In general, I expect that you will act with integrity in all that you do in this class. The contract grading system we will use this semester places a lot of trust in you to not just meet the nominal standards contained within the contract, but to *push yourself* to produce your best work.
